...
const Data = {
  environments: [
    'https://access.sites.dev.thirdstream.ca/inbranch/deposits/en/app/flow/welcome',
    'https://access.sites.qa.thirdstream.ca/inbranch/deposits/en/app/flow/welcome',
    'https://access.sites.test.thirdstream.ca/inbranch/deposits/en/app/flow/welcome/?idp=3S',
    'https://access.sites.staging.thirdstream.ca/inbranch/deposits/en/app/flow/welcome?idp=3S',
    'https://access.sites.staging.thirdstream.ca/inbranch/deposits/en/app/flow/welcome'
  ],
  devices: [
  ...
  users: [
    {
      ...
      onlineBanking: 'Yes',
      caslConsent: 'Yes',
      businessRelationship: 'Basic Personal Financial Services and Lending',
      usPerson: 'No',
...
test('Access_RDI', async ({ }) => {
  ...
  // 👤 Adult Applicants
  const selectedUsers = ['Kevin'].map(getUserByFirstName); // You can change this to 'Helen', 'Sue', 'Tom'
...
const selectSMSVerificationStatus = 'Disable'; //Enable or Disable
...
if (selectSMSVerificationStatus === 'Enable') {
  ...
  await page.locator('div').filter({ hasText: /^empty$/ }).first().click();
  await page.getByRole('option', { name: selectApplyoverdraft, exact: true }).nth(1).click();
  //??
  ...
  for (const user of selectedUsers) {
    ...
    await page.locator('span').filter({ hasText: 'emptyMethod' }).locator('div').first().click();
    await page.getByRole('option', { name: 'Government Photo ID' }).first().click();
    await page.locator('#identification-type-dropdown > div').click();
    await page.getByRole('option', { name: 'Valid Passport' }).click();
    await page.getByRole('textbox', { name: 'Number', exact: true }).fill('888888');
    ...
    await page.getByRole('textbox', { name: 'Social Insurance Number' }).type(generateRandomSIN());
    ...
    await page.getByRole('option', { name: 'Altona' }).click();
    // member card
    ...
    await page.locator('#casl-dropdown > div').click();
  ...
  await page.locator('div').filter({ hasText: /^empty$/ }).first().click();
  await page.getByRole('option', { name: 'Ability Chequing', exact: true }).first().click();
  ...
  await page.getByRole('button', { name: 'Next' }).click();
    ...
    await page.waitForTimeout(3000);
    await page.locator("(//button[@title='Edit'])[2]").click(); // confirmation page
